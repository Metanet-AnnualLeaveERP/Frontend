        ...
        <div class="side-content-wrap">
            ...
            >
                <ul
                    ...
                    :class="
                        selectedParentMenu == 'calendar' ? 'block' : 'hidden'
                    "
                >
                    <li>
                        <router-link :to="{ name: 'bryntum' }">
                            <i
                                class="nav-icon i-Checked-User text-base mr-2"
                            ></i>
                            <span class="item-name"> BryntumCalendar </span>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'simple' }">
                            <i
                                class="nav-icon i-Checked-User text-base mr-2"
                            ></i>
                            <span class="item-name"> vue-simple-calendar </span>
                        </router-link>
                    </li>
                    <li>
                        <router-link to="/sessions/login">
                            <i
                                class="nav-icon i-Checked-User text-base mr-2"
                            ></i>
