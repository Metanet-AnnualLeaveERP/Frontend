  ...
  <div>
    ...
    <BaseCard class="h-full">
      ...
      >
        ...
        >
          <div class="text-2xl">No. {{ cancelReq?.cancelId }}</div>
          <div class="text-1xl lg:text-1xl">
            [요청일자] {{ cancelReq?.cancelReqDate }}
          </div>
          <div>
            <base-btn
              :class="setStatusStyle(cancelReq?.cancelStatus)"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 font-black font gap-x-8">
        ...
        <div class="border-2 col-span-full rounded-2xl">
          <div class="text-gray-400 dark:text-white p-2">요청사유</div>
          <div class="flex flex-row rounded-sm p-2 m-2 justify-between">
            {{ cancelReq.reqComm }}
          </div>
        </div>
    ...
    <div
      ...
      v-if="
        (cancelReq?.cancelStatus === '대기중' && role === 'ROLE_MGR') ||
      ...
      >
        ...
        >
          ...
          <h3 class="flex-col flex text-2xl font-bold text-end items-end">
            ...
            <div class="w-full">
              <div class="text-1xl">요청일자 {{ cancelReq.cancelReqDate }}</div>
            </div>
          </h3>
        </div>
