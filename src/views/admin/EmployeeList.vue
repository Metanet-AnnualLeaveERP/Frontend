      ...
      <div class="grid grid-cols-12 gap-5">
        <div class="col-span-12">
          <BaseCard>
            <div class="flex flex-row justify-between mb-4">
              <div class="w-full">
                <div class="w-full text-gray-700">
                  ...
                  <div class="relative grid w-2/3 lg:w-1/4 grid-cols-1 right-0">
                    <div
                    ...
                    <div
                        v-show="isOpenDept"
                        class="absolute top-11 left-0 right-0 z-10 bg-white rounded-md shadow-md border
                      border-gray-300 px-3 py-2 text-gray-700 font-medium cursor-pointer"
                    >
            ...
            <div class="relative text-gray-600 search-bar w-full">
              <div class="relative lg:flex-row-reverse lg:items-center lg:align-middle">
                <button
                    role="button"
              ...
              <input
                  class="bg-purple-50 w-full bg-gray-100 dark:bg-dark border-transparent h-10 px-5 pr-10 rounded-full text-sm focus:outline-none"
                  placeholder="이름검색"
                  v-model="keywordName"
              />
            </div>
            <div class="grid grid-cols-1 justify-items-end mb-5">
              <BaseBtn
                  class="bg-primary text-white hover:bg-blue-700 mt-5"
                  :md="true"
                  @click="addMember"
              >직원등록
              </BaseBtn
