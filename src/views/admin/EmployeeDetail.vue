    ...
    <div class="grid grid-cols-1 md:grid-cols-2 justify-items-center">
      ...
      <div class="w-full flex flex-col ">
        ...
        <div class="m-4 flex gap-x-2 justify-between align-middle items-center">
          ...
          <input type="text" v-model="detail.hireDate" :class="className.inputName" id="carNumber" disabled>
        </div>
        <div class="m-4 flex gap-x-1 justify-between align-middle items-center">
          <span class="text-xl mr-4">사내메일&nbsp;</span>
          <input type="text" v-model="detail.pEmail" :class="className.inputName" id="carNumber" disabled>
        </div>
        <div class="m-4 flex gap-x-1 justify-between align-middle items-center">
          <span class="text-xl mr-4">개인메일&nbsp;</span>
          <input type="text" v-model="detail.cEmail" :class="className.inputName" id="carNumber" disabled>
        </div>
      </div>
    </div>
  </BaseCard>
  <div class="flex mt-5 justify-end">
  <BaseBtn class="bg-primary text-white mr-5 font-weight: bold" style="width: 200px; height: 50px;" @click="modifyInfo">수정하기
</BaseBtn>
  <BaseBtn class="bg-primary text-white ml-5 font-weight: bold" style="width: 200px; height: 50px;" @click="disableAccount">비활성화
  </BaseBtn>
  </div>
